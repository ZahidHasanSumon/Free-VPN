    ...
    return Card(
        ...
        child: InkWell(
          ...
          child: ListTile(
            ...
            //title
            title: Text(vpn.countryLong, style: TextStyle(
            ...
            subtitle: Row(
              children: [
                Icon(Icons.speed_rounded, color: darkMode ? Colors.white : Colors.black, size: 20),
                SizedBox(width: 4),
                Text(_formatBytes(vpn.speed, 1), style: TextStyle(fontSize: 13, fontFamily: 'SpaceGrotesk',))
              ],
            ),
              ...
              children: [
                Text(vpn.numVpnSessions.toString(),
                    style: TextStyle(
                        ...
                        fontFamily: 'SpaceGrotesk',)),
                SizedBox(width: 4),
                Icon(CupertinoIcons.person_3, color: darkMode ? Colors.white : Colors.black),
              ],
            ),
          ),
        ));
